...
data = pd.read_excel('pandas_simple_full.xlsx')
col_idx = ['Spirits and liqueurs (brought home)', 'Wines, fortified wines (brought home)', 'Beer, lager, ciders and perry (brought home)',	'Alcopops (brought home)', 'Cigarettes', 'Cigars, other tobacco products and narcotics']

denominator_col = 'Alcoholic drink, tobacco and narcotics'
...
# Create a Pandas Excel writer using XlsxWriter as the engine.
writer = pd.ExcelWriter('pandas_simple_updated2.xlsx', engine='xlsxwriter')
