...
df_no_all['All_75_Over'].plot(label="All 75 Over")
df_no_all['All_Under_16'].plot(label="All Under 16")
plt.legend(loc="upper left")
plt.xlim(0.5,4.5)
plt.xticks([1,2,3,4,5,6,7,8])
plt.ylabel('Rate')
plt.title('Min and max admission rates over past years')
plt.gca().invert_xaxis()
plt.show()
#plt.savefig('admitted_min_max.png')
